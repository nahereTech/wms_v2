...
?>
 ...
 -->
        ...
        <!-- /page content -->
        <!-- modal -->
        <div class="modal fade" id="modal_bills" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
