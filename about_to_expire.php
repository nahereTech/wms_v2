...
?>
                      ...
                      <table class="table table-striped jambo_table bulk_action">
                        <thead>
                          <tr class="headings">
                            ...
                            <th class="column-title no-link last"><span class="nobr">Batch Name</span>
                            <th class="column-title no-link last"><span class="nobr">Current Qty</span>
                            <th class="column-title no-link last"><span class="nobr"> Total Qty(Warehouse)</span>
        ...
        <script type="text/javascript">
          ...
          function list_of_low_items(page){
                    ...
                    if (response.status == '200'){
                        ...
                        if(response.data != undefined){
                            ...
                            $.each(response.data.items, function (i, v) {
                              ...
                              strTable += '<tr>';
                              strTable += `<td>${v.ItemDetails.name}</td>`;
                              strTable += `<td>${v.batchDetails.name}</td>`;
                              strTable += `<td>${v.ItemDetails.totalQtyLeft}</td>`;
                              strTable += `<td>${v.ItemDetails.totalQtyAcrossWarehouses}</td>`;
