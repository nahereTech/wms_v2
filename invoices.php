                    ...
                    if (response.status == '200'){
                        ...
                        if(response.data.length > 0){
                            ...
                            $.each(response['data'], function (i, v) {
                              ...
                              strTable += '<td valign="top"><a class="view_invoice_icon" id="inv_'+response['data'][i]['inv_id']+'"><i  class="fa fa-info-circle"  data-toggle="tooltip" data-placement="top" style="cursor: pointer; font-style: italic; color: #add8e6; font-size: 20px;" title="View Incoming Item info"></i></a>';
                              ...
                              strTable +=  '<a class="delete_incoming" style="cursor: pointer;" id="inc_'+response['data'][i]['item_id']+'"><i  class="fa fa-trash"  data-toggle="tooltip" data-placement="top" style="font-style: italic; color: #f97c7c; font-size: 20px;" title="Delete Incoming Item"></i></a></td>';
