                    ...
                    if (response.status == '200'){ 
                        ...
                        if(response.total_rows != 0){
                            ...
                            list_mds+=`<span><div class="col-md-3 first_" data-tooltip="Social"><div class="">
                               ...
                               right: 20%;" href="../workgroup" class="get_comp_list" id="themodli_"  data="feeds"><span class="image"><img src="../files/images/icons/feeds_icon.png" alt=""></span>     <span>        <div class="abbrv" ><span class="hide_hover">Social</div></span></span>   </a></li></div></div></span>`;
                            $.each(response.data, function (i, v) {
...
function fetch_feeds(page){ 
            ...
            $.ajax({ 
                ...
                data: { "company_id" : company_id , "user_id" : user_id , "limit" : limit , "page" : 1 , "token" : localStorage.getItem('token')  },
                timeout: 60000,
                success: function(response) {
...
<!-- <i class="fa fa-spinner fa-spin fa-fw fa-3x" id="preloader_loader" style="display: flex; align-items: center; justify-content: center;"></i> -->
  ...
  <div id="whole_body" > <!-- page beside loader section -->
