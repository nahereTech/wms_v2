    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            if (localStorage.getItem('user_id') == "" || localStorage.getItem('user_id') == null || localStorage.getItem('company_id') == "" || localStorage.getItem('company_id') == null) {
                ...
                //2. can user access page
                //3. get list of apps user can access global
                //4. get profile details for right top corner if needed

                //5. what is users role in module
                //is profile set up and warehouse is set up
                //if not (if user is admin, push to biz profile page) (if user is user, show error page and tell him to tell admin to complete the setup)
                //if yes
                //6. fetch module roles or roles in the modules for this user    
            ...
            $.ajax({
                ...
                success: function(response) {
                    ...
                    if (response.status == '200') {
                        ...
                        // alert("now "+localStorage.getItem('warehouse_name'));
                        // alert(warehouse_id);
                        ...
                        if($("#user_perm_status").html() == "super_admin" || $("#user_perm_status").html() == "admin"){
                            ...
                            $("#page_error_div").html('<i class="fa fa-exclamation-triangle" aria-hidden="true"></i>&nbsp;&nbsp;You have access to the WMS of this company but you have not been connected to a warehouse. Please contact admin to fix this. <a href="../feeds" style="color: white"><u>Back to Feeds</u></a>');
                            $(".container33").hide();
                            $("#page_error_div").show();
                            $("#whole_body").hide();
                        }      
                    ...
                    if (response.status == '200') {
                        ...
                        $.each(response['data']['profile_details'], function(i, v) {
                            ...
                            if (v.id == 2) { //Procurement
                                ...
                                $("#incoming_tab").show();//show incoming tab
                                $("#po_tab").show(); //show po page
                                $("#paystovendors").show(); //show payment to vendors
                                $("#contacts").show(); // show contact page
                                $("#items").show(); //show items page
                            }

                            if (v.id == 3) { //Store Manager

                                $("#incoming_tab").show();//show parent incoming tab
                                $("#receivepoitems").show(); // receive items into warehouse


                                $("#outgoing_tab").show(); //show outgoing tab
                                $("#supplyitems").show(); //show outgoing tab
                            ...
                            if (v.id == 1) { //Admin
                                $("#settings_tab").show();
                                //set a variable telling that this person is an admin
                                an_admin = "yes";
                            }

                            if (v.id == 4) { //Sales Personal

                                $("#outgoing_tab").show();
                                $("#paysfromclients").show();
                            ...
                            // if (v.role_id == 7) { //Invoices & Receipts

                            //     $("#incoming_tab").show();
                            //     $("#invoicesreceipts").show();
                            // }

                            // if (v.role_id == 17) { //Payments from Clients
                            //     $("#incoming_tab").show();
                            //     $("#paysfromclients").show();
                            // }
                            ...
                            <ul class="nav side-menu" style="display: ;" id="main_menu">
                                ...
                                <li id="incoming_tab" style="display: none;"><a><i class="fa fa-cart-arrow-down"></i> Incoming <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                      <li id="po_tab" style="display: none;"><a href="po_test">Receive Orders</a></li>
                                      <li id="paystovendors_2" style="display: none;"><a href="paystovendors">Payments to Vendors</a></li>
                                      <li id="receivepoitems" style="display: none;"><a href="receivepoitems">Receive Items</a></li>
                                    </ul>
                                  </li>
                                  <li id="outgoing_tab" style="display: none;"><a><i class="fa fa-arrow-up"></i> Outgoing  <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                      ...
                                      <li id="invoicesreceipts" style="display: none;"><a href="invoicesreceipts">Invoices/Receipts</a></li>
                                      <li id="paysfromclients" style="display: none;"><a href="paysfromclients">Payments from Clients</a></li>
                                      <li id="supplyitems" ><a href="supplyitems">Issue Orders</a></li>
                                    </ul>
                                </li>
                                ...
                                <li id="settings_tab" style="display: none;"><a><i class="fa fa-gear"></i> Settings <span class="fa fa-chevron-down"></span></a>
                                    <ul class="nav child_menu">
                                        ...
                                        <li><a href="whsections">Warehouse Sections</a></li>

                                    </ul>
                                </li>

                                <li id="reports" style="display: ;"><a href="reports"><i class="fa fa-bar-chart"></i> Reports </a>
                                </li>

                                <li id="switch_tab" style="display: none;"><a id="switch"><i class="fa fa-arrow-up"></i> Switch Warehouse</a>
                                </li>
